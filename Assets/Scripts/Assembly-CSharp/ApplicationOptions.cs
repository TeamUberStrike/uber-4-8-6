...
public class ApplicationOptions
{
	...
	public const float CameraFovSliderMin = 50f;

	public const float CameraFovSliderMax = 100f;
	...
	public void Initialize()
	{
		...
		if ("4.8.6" != text)
		{
			...
			PlayerPrefs.SetString("Version", "4.8.6");
		}
		...
		if ((Application.platform == RuntimePlatform.OSXPlayer || Application.platform == RuntimePlatform.OSXPlayer || Application.platform == RuntimePlatform.IPhonePlayer || Application.platform == RuntimePlatform.Android) && VideoWaterMode == 2)
		{
			VideoWaterMode = 1;
		}
		...
		CameraFov = Mathf.Clamp(CmunePrefs.ReadKey(CmunePrefs.Key.Options_CameraFov, CameraFov), CameraFovSliderMin, CameraFovSliderMax);
	...
	public void SaveApplicationOptions()
	{
		...
		CmunePrefs.WriteKey(CmunePrefs.Key.Options_CameraFov, CameraFov);
