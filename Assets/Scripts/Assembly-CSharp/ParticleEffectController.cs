...
public class ParticleEffectController : MonoBehaviour
{
	...
	{
		// Null guard: _pickupParticleEmitter is a legacy Unity 4 ParticleEmitter
		// reference. The legacy particle components were stripped from scene
		// files during the Unity 6 migration (see strip_legacy_scene_components.py)
		// so the field is null at runtime. Silent skip — pickup sound still plays.
		if ((bool)Instance && Instance._pickupParticleEmitter != null)
		{
