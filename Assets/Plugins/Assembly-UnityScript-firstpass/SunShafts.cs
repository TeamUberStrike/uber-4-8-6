...
public class SunShafts : PostEffectsBase
{
	...
	{
		// Unity 6 passthrough: the legacy sunShaftsMaterial shader passes don't
		// write to the destination in Unity 6's render pipeline, leaving the
		// screen pitch black when SunShafts is attached to a map camera.
		// Just blit the source through so rendering stays visible.
		// Same pattern as the Bloom.cs neutering from an earlier session.
