...
public class Bloom : PostEffectsBase
{
	...
	{
		// Unity 6 stripped passes from Hidden/BlendForBloom (4 passes now, was 11+)
		// and Hidden/BlurAndFlares — the legacy code below indexes passes 6, 10, etc.
		// which throws "Invalid pass number" and produces a black screen. Until this
		// is replaced with the URP/HDRP Bloom equivalent (or rewritten against the
		// modern pass layout), short-circuit to a passthrough so the camera renders
		// the scene unmodified. Original implementation preserved under #if false.
