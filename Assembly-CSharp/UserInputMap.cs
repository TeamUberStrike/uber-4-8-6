...
public class UserInputMap
{
	...
	public string GetPlayerPrefs()
	{
		using (MemoryStream memoryStream = new MemoryStream())
		{
			...
			return UnityWebRequest.EscapeURL(Encoding.ASCII.GetString(memoryStream.ToArray()), Encoding.ASCII);
		}
	}

	public void ReadPlayerPrefs(string pref)
	{
		byte[] bytes = Encoding.ASCII.GetBytes(UnityWebRequest.UnEscapeURL(pref, Encoding.ASCII));
